    ...
    <ContainerAbout>
      <ContainerText>
        ...
        <TextAbout lh='24px' pt='20px' pb='20px'>
          ...
          web. Actualmente estoy enfocado principalmente en javascript, y la creación de apps con React JS.
        </TextAbout>
        <TitleAbout size='20px' weight='400'>Objetivos y Tecnologías</TitleAbout>
        <TextAbout lh='24px' pt='20px' pb='20px'>
          Me encuentro en busca de nuevos retos profesionales, me gustaría adquirir
          ...
          React Native, Next Js, Gatsby Js.
        </TextAbout>
      </ContainerText>
      <ContainerImage>
